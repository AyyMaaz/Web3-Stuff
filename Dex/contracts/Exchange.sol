...
*/
//giving eth and we want cryptotoken
function ethToCryptoDevToken(uint _minTokens) public payable {
    // one is eth=msg.value u will select  and other is the token u will sellect
...
*/
//giving cryptotoken and we want eth
